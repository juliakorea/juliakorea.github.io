function blame(pagename) {
  var translated = ["index", "manual/complex-and-rational-numbers", "manual/getting-started", "manual/integers-and-floating-point-numbers", "manual/introduction", "manual/mathematical-operations", "manual/variables", "phdthesis/chap6"];
