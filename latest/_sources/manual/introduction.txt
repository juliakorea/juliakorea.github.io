...
당사자인 연구자들은 속도가 느릴지라도 동적인 언어를 사용해 그들의 업무를
처리한다. 동적인 언어를 즐겨쓰는 이유를 들어보니 이런 추세가 쉽게
사그라들 것 갈지도 않다. 다행히 근래의 언어 디자인과 컴파일러 기법의
...
줄리아 컴파일러는 파이썬, R과 같은 언어와 다르다. 해서 줄리아의 성능은
처음 보면 조금 의아하다. 막상 작성한 코드가 느리다면 "성능 향상 팁"을
읽어보길 권한다. 줄리아가 어떤 식으로 작동하는지 이해한다면, C로
